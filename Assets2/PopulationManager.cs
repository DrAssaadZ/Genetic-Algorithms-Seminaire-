...
public class PopulationManager : MonoBehaviour {
	...
	//taking both parents and creating an offspring
	GameObject Breed(GameObject parent1, GameObject parent2)
	{
		...
		if(Random.Range(0,100) == 1) //mutate 1 in 100 times
		{	
			//init the brain then performing the mutation
			b.Init();
			b.dna.Mutate();
		}
		else
		{ 
			//combining parents dnas
			b.Init();
	...
	{
		//sorting the population ordered by the time alive
